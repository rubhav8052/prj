...
# raw_data\az_im\tl_inlays2\full_dataset_2.csv


# ///////////////////////

config.input_csv_paths = ["raw_data/az_im/tl_inlays2/full_dataset_2.csv"]
config.image_base_dir = 'raw_data/az_im/tl_inlays2/'

config.output_dir = "raw_data/raw_output"
...
config.attribute_prompt_file = 'src/prompts/tl_inlay_prompt.py'
