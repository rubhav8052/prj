...
class DataPrepConfig:
    ...
    input_csv_paths: List[str] = field(default_factory=lambda: [
    "raw_data/az_im/tl_inlays2/full_dataset_2.csv"])
    ...
    image_base_dir: str = 'raw_data/az_im/tl_inlays2/'
    ...
    output_dir: str = "raw_data/raw_output"
    ...
    attribute_prompt_file: Optional[str] = 'src/prompts/tl_inlay_prompt.py'
